...
// Discord's official mark, used per their brand guidelines for "Continue with Discord" buttons.
...
export function DiscordSignInButton() {
  ...
  return (
    <Button
      type="button"
      variant="outline"
      className="w-full gap-2 border-[#5865F2]/30 text-[#5865F2] hover:bg-[#5865F2]/5 hover:text-[#5865F2]"
      disabled={loading}
      onClick={() => {
        setLoading(true);
